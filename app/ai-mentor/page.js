        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-[#5C4435] max-w-2xl mx-auto leading-relaxed">
              Get intelligent guidance on your learning journey. Ask me
              anything about skills, projects, interviews, or career
              development.
            </p>
          </div>
          ...
          <div className="bg-white border border-[#E2C9A0] rounded-[32px] shadow-lg overflow-hidden">
                  ...
                  <div className="bg-[#FDF6EE] border border-[#E2C9A0] rounded-2xl px-4 py-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex gap-1">
                        ...
                        <div
                          className="w-2 h-2 bg-[#C49A6C] rounded-full animate-bounce"
                      ...
                      <span className="text-[#8B6F60] text-sm">
                        AI Mentor is typing...
                      </span>
            ...
            {messages.length === 1 && !isLoading && (
              <div className="px-4 sm:px-6 pb-4 border-t border-[#E2C9A0]">
                ...
                <p className="text-sm text-[#8B6F60] mb-3 mt-3">
                  Try asking:
                </p>
